...
const PageContainer: React.FC<PageContainerProps> = ({ collapsedAt, hasActionBar, children }) => {
    ...
    return <div data-testid="PageContainer" className={clsx("PageContainer", navState && navState, { hasActionBar })}>
