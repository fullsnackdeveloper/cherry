...
const PageContainer: React.FC<PageContainerProps> = ({ collapsedAt, hasActionBar, hasSteps, children, shadedBackground }) => {
    ...
    return <div data-testid="PageContainer" className={clsx("PageContainer", navState && navState, { hasActionBar, hasSteps, shadedBackground })}>
