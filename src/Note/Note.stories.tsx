...
export const Default = () => <Note type="tip" html="<p><b>Tip:</b> Make sure you use the correct size wick for your jar! If you don’t your candle won’t burn properly (I learned this the hard way). Be sure to ask someone when you are buying the wick to advise you on the correct size.</p>" />;
